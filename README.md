...
This project repository contains a detailed analysis of a [large Spotify Audio dataset](https://www.kaggle.com/datasets/sunnykakar/spotify-charts-all-audio-data/data).

## 1. Introduction
### 1.1 Dataset Selection 
Upon investigating data sets that fit both the size requirements and was of enough relative salience and interest, I selected the [Spotify Audio dataset](https://www.kaggle.com/datasets/sunnykakar/spotify-charts-all-audio-data/data). This data set contained enough specific information and properties, and real world relevance, that it was determined as useful for exploring data science efforts.
...
Given the salience of recommender systems in our economy, the next question is how can our model and data science efforts contribute to these practices; what follows is a broader summary of the findings and how they are discussed in the paper ahead.

This chosen data set is composed of stream counts by region, by time period, and by track, accompanied by a myriad of metrics related to each track (energy, danceability, length, etc), and popularity is ranked and comparatively scored. This lends us to the following sense of what we can offer in the lines of recommendation systems: 
